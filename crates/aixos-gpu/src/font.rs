...
// Public-domain 8x8 bitmap font (IBM VGA lineage, via font8x8 by Daniel Hepper).
// Bit order: LSB of each row byte = leftmost pixel.
...
pub fn draw_char(x: u32, y: u32, c: char, color: u32) {
